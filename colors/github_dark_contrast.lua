...
hi(0, "@lsp.type.namespace", { fg = c.fg })
...
hi(0, "rustSigil", { fg = c.syn_label })
hi(0, "rustEscape", { fg = c.syn_string_special })
hi(0, "rustStringContinuation", { fg = c.syn_function })
hi(0, "rustEnum", { fg = c.syn_type })
hi(0, "rustStructure", { fg = c.syn_function })
hi(0, "rustModPathSep", { fg = c.fg_muted })
hi(0, "rustCommentLineDoc", { fg = c.syn_comment })
hi(0, "rustDefault", { fg = c.syn_function })
